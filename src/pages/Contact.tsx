              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" id="name" name="name" value={formData.name} onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border ${errors.name ? 'border-red-500' : 'border-gray-300 focus:border-red-500'} focus:outline-none focus:ring-2 focus:ring-red-500/20 bg-white`}
                  ...
                  <div>
                    ...
                    <input type="email" id="email" name="email" value={formData.email} onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-300 focus:border-red-500'} focus:outline-none focus:ring-2 focus:ring-red-500/20 bg-white`}
                ...
                <div>
                  ...
                  <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={5}
                    className={`w-full px-4 py-3 rounded-lg border ${errors.message ? 'border-red-500' : 'border-gray-300 focus:border-red-500'} focus:outline-none focus:ring-2 focus:ring-red-500/20 bg-white resize-none`}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${shopInfo.phone.replace(/\D/g, '')}`} className="text-red-600 hover:text-red-700 font-semibold">{shopInfo.phone}</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${shopInfo.email}`} className="text-red-600 hover:text-red-700 font-semibold">{shopInfo.email}</a>
                    </div>
                  </div>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div key={index} className="bg-cream rounded-xl p-6"
                initial={{ opacity: 0, y: 20 }}
